<div class="card card-secondary">
  ...
  <form action="./report/saldo_per.php" method="post" enctype="multipart/form-data" target="_blank">
    <div class="card-body">
    ...
    <div class="card-footer">
      ...
      <a href="./report/saldo_full.php" class="btn btn-primary" target="_blank">Cetak Semua</a>
    </div>
  </form>
</div>
